...
function Hotel() {
  ...
  const text = 'Гостиница Отель Мандарин Москва расположена в городе Москва в 3,8 км от центра. Количество звёзд: 4. Здесь созданы все условия для комфортного проживания — есть кондиционер, телевизор, фен, утюг, чай/кофе в номерах, посуда, чайник, сейф, отопление, терраса, мини-бар. По запросу предоставляются номера для курящих. Уборка — каждый день. В гостинице есть ресторан, бар, тренажёрный зал, конференц-зал. Есть возможность взять напрокат велосипед. У каждого гостя будет доступ в интернет, вы сможете выложить фотографии, отправить файл или позвонить родным по видео. Учитывайте время заселения в гостиницу. Заезд здесь начинается с 15:00, выехать нужно до 12:00. Даже если вы прибудете поздно ночью, вас встретят на круглосуточной стойке регистрации и помогут с размещением. Лифт внутри есть. В гостинице есть и удобства для людей с ограниченными возможностями. Если вы на машине, можете оставить её на платной парковке. Если вы добираетесь своим ходом, воспользуйтесь услугой трансфера. К вашим услугам: прачечная, обслуживание номеров, консьерж-сервис, камера хранения, ускоренная регистрация заезда/отъезда.';
