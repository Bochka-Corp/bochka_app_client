...
function Hotel() {
  ...
  const text = 'Гостиница Арбат Хаус расположена в историческом центре Москвы. В 7-ми минутах ходьбы от м.Арбатская и в 3 минутах от ул.Новый Арбат. Когда-то здесь располагалась Поварская слобода, отсюда и сохранившиеся названия близлежащих переулков: Хлебный, Ножовый, Столовый, Чашников, Поварская. Сейчас это тихий хорошо охраняемый район, где находятся посольства и представительства многих иностранных государств. Местоположение гостиницы является идеальным как для деловых людей (10 минут до Москва-Сити и Экспоцентра на Красной Пресне), так и для туристов (в шаговой доступности пешеходная улица Арбат, Красная площадь, Большой театр и другие исторические и культурные достопримечательности города).';
        ...
        <div className="hotel__info_interactive">
          <div className="hotel__gallery">
            ...
            <div className="hotel__gallery-container">
              <div className="hotel__gallery-images" style={positionStyle}>
                {
                  hotel.images.map((imageInfo, index) => (
                    <HotelImage
                      image={imageInfo}
                      key={imageInfo + index}
                    />
              ...
              <button
                ...
                disabled={hotel.images.length - 1 === position}
          ...
          <div className="hotel__map">
            ...
            <div className="hotel__map-container">
              <YMaps>
                <Map className="hotel__map-content" defaultState={{ center: hotel.coordinates, zoom: 14 }}>
                  <Placemark
        ...
        <div className="hotel__cards">
          {
            hotel.rooms.map((room, index) => (
              <RoomCard data={room} key={index + room.name} />
            ))
          }
        </div>
