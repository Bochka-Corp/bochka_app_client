        ...
        <div className="hotel__info_interactive">
          <div className="hotel__gallery">
            ...
            <div className="hotel__gallery-container">
              ...
              <button type="button" className="hotel__gallery-btn hotel__gallery-btn_left" disabled={position === 0} onClick={handleClickPrevious}>
                <svg
                  width="24"
                  height="24"
                  fill="none"
              ...
              <button type="button" className="hotel__gallery-btn hotel__gallery-btn_right" disabled={wallpapers.length - 1 === position} onClick={handleClickNext}>
                <svg
